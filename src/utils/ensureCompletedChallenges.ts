    ...
    if (!snap.empty) {
      ...
      const updates = snap.docs.map(async (docSnap) => {
        ...
        await updateDoc(ref, {
          ...
          "completedLocalQuiz.javascripteasy": [],
          "completedLocalQuiz.javascriptmedium": [],
          "completedLocalQuiz.javascripthard": [],
          "completedLocalQuiz.javaeasy": [],
          "completedLocalQuiz.javamedium": [],
          "completedLocalQuiz.javahard": [],
          "completedLocalQuiz.pythoneasy": [],
          "completedLocalQuiz.pythonmedium": [],
          "completedLocalQuiz.pythonhard": [],
          "completedLocalQuiz.reacteasy": [],
          "completedLocalQuiz.reactmedium": [],
          "completedLocalQuiz.reacthard": [],
          "completedLocalQuiz.golangeasy": [],
          "completedLocalQuiz.golangmedium": [],
          "completedLocalQuiz.golanghard": [],
