import CodeClashHost from "../../components/codeClashSettingsComp/codeClashHost"
import CodeClashJoin from "../../components/codeClashSettingsComp/codeClashJoin"
const settings = () => {
  return (
    <>
...
<div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 via-transparent to-purple-500/5 z-30"></div>
    ...
    <span className='flex justify-center pt-[4rem] md:pt-[6rem]'>
          <h1 className='inline-block text-center font-bold text-4xl text-[#00ff7f] drop-shadow-[0_0_10px_rgba(34,197,94,0.8)] pr-5 font-dmsans'>Explore</h1><h1 className='font-bold text-4xl text-white inline-block'>Code Clash</h1>
    </span>
